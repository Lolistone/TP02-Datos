...
En busqueda del mejor modelo, se exploraron diversas combinaciones de hiper-parametros. Para eso se realiza un Grid Search tomando en cuenta los profundidades entre 10 y 14, y los criterios, entropia y gini. A continuación tenemos una tabla con los resultados.
...
Ahora, ya con nuestro modelo elegido, a través de una prueba de precisión con los conjuntos de test, obtenemos una precision del 0.967, la cual nos parece realmente acertada. \vspace{0.05cm}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{Imagenes/matriz_confusion_arbol.png}
  \caption{matriz confusion}
  \label{fig:Tabla 1}
\end{figure}
